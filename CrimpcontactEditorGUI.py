...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.9pre on Wed Sep  2 22:29:31 2020
#
...
class CrimpcontactEditorGUI(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        grid_sizer_1 = wx.FlexGridSizer(2, 5, 5, 5)
        ...
        self.cbXSection.SetMinSize((100, 25))
        ...
        grid_sizer_1.Add(self.cbSlot, 0, wx.LEFT, 5)
        
        self.tcSoll = wx.TextCtrl(self.panel_1, 425, "")
        self.tcSoll.SetMinSize((60, 22))
        self.tcSoll.Enable(False)
        grid_sizer_1.Add(self.tcSoll, 0, wx.LEFT, 5)
        ...
        self.lcCrimptools.SetFont(wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        self.lcCrimptools.AppendColumn("Querschnitt", format=wx.LIST_FORMAT_LEFT, width=110)
        self.lcCrimptools.AppendColumn("Crimpzange", format=wx.LIST_FORMAT_LEFT, width=400)
