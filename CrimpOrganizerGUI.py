...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.9pre on Thu Sep 24 21:57:43 2020
#
...
class CrimpOrganizerGUI(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.optCrimpContact = wx.Menu()
        self.mbOrganizer.optCCNew = self.optCrimpContact.Append(wx.ID_ANY, "Neu", "")
        self.mbOrganizer.optCCEdit = self.optCrimpContact.Append(wx.ID_ANY, "Bearbeiten", "")
        self.mbOrganizer.optCCDelete = self.optCrimpContact.Append(wx.ID_ANY, u"Löschen", "")
        self.mbOrganizer.Append(self.optCrimpContact, "Crimpkontakte")
        self.optCrimpTool = wx.Menu()
        self.mbOrganizer.optCTManage = self.optCrimpTool.Append(wx.ID_ANY, "Verwalten", "")
        self.mbOrganizer.Append(self.optCrimpTool, "Crimpzangen")
        self.optCrimpInstructions = wx.Menu()
        self.mbOrganizer.optCIDelScheme = self.optCrimpInstructions.Append(wx.ID_ANY, "Zeichnung entfernen", "")
        self.mbOrganizer.optCIDelContact = self.optCrimpInstructions.Append(wx.ID_ANY, "Kontakt entfernen", "")
        self.mbOrganizer.optCIReannotate = self.optCrimpInstructions.Append(wx.ID_ANY, u"Pos./Gehäuse neu zuweisen", "")
        self.mbOrganizer.Append(self.optCrimpInstructions, "Crimpanweisungen")
        ...
        self.btnUseTools = wx.Button(self.mainPanel, wx.ID_ANY, "Crimpzangen verwenden")
        self.btnUseTools.Enable(False)
        sizer_5.Add(self.btnUseTools, 0, wx.BOTTOM | wx.LEFT | wx.TOP, 5)
