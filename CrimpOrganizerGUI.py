...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.9pre on Tue Aug 25 19:30:36 2020
#
...
class CrimpOrganizerGUI(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        static_text_1.SetMinSize((110, 17))
        static_text_1.SetFont(wx.Font(14, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        ...
        sizer_3.Add(self.lcContacts, 0, wx.ALL | wx.EXPAND, 5)
        
        sizer_3.Add((20, 21), 0, wx.ALL, 5)
        ...
        static_text_2.SetMinSize((100, 17))
        static_text_2.SetFont(wx.Font(14, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        ...
        sizer_5.Add(self.panel_1, 0, wx.LEFT | wx.RIGHT | wx.TOP, 5)
        ...
        static_text_3 = wx.StaticText(self.mainPanel, wx.ID_ANY, "Crimpanweisung")
        static_text_3.SetFont(wx.Font(14, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        sizer_6.Add(static_text_3, 0, wx.LEFT | wx.RIGHT | wx.TOP, 5)
        
        self.btnRemoveEntry = wx.Button(self.mainPanel, wx.ID_ANY, "Eintrag entfernen")
        self.btnRemoveEntry.Enable(False)
        sizer_6.Add(self.btnRemoveEntry, 0, wx.ALL, 5)
        
        self.panel_2 = wx.Panel(self.mainPanel, wx.ID_ANY)
        self.panel_2.SetMinSize((230, 21))
        sizer_6.Add(self.panel_2, 0, wx.LEFT | wx.RIGHT | wx.TOP, 5)
        
        self.lcUseContacts = wx.ListCtrl(self.mainPanel, wx.ID_ANY, style=wx.LC_HRULES | wx.LC_REPORT | wx.LC_VRULES)
        self.lcUseContacts.SetMinSize((250, 287))
        self.lcUseContacts.AppendColumn("Querschnitt", format=wx.LIST_FORMAT_LEFT, width=95)
        self.lcUseContacts.AppendColumn("Artikelnr.", format=wx.LIST_FORMAT_LEFT, width=155)
        sizer_6.Add(self.lcUseContacts, 1, wx.ALL | wx.EXPAND, 5)
        ...
        sizer_6.Add(self.btnCreateInstructions, 0, wx.ALL, 5)
