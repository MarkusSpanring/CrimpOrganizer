...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.9pre on Wed Sep  9 13:07:36 2020
#
...
class CrimpOrganizerGUI(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.lcToolSummary.AppendColumn(u"Ø", format=wx.LIST_FORMAT_LEFT, width=50)
        ...
        self.lcCrimpInstructions.SetMinSize((300, 454))
        ...
        self.lcCrimpInstructions.AppendColumn(u"Ø", format=wx.LIST_FORMAT_LEFT, width=50)
