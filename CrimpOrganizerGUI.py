...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.9pre on Wed Sep  9 14:23:10 2020
#
...
class CrimpOrganizerGUI(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        sizer_10.Add(sizer_2, 0, wx.LEFT | wx.RIGHT | wx.TOP, 5)
        
        self.tcSchemeNr = wx.TextCtrl(self.mainPanel, wx.ID_ANY, "")
        self.tcSchemeNr.SetMinSize((115, 22))
        sizer_2.Add(self.tcSchemeNr, 0, wx.LEFT | wx.RIGHT, 5)
        
        stSchemeRev = wx.StaticText(self.mainPanel, wx.ID_ANY, "Rev.:")
        sizer_2.Add(stSchemeRev, 0, wx.ALIGN_CENTER, 5)
        
        self.tcSchemeRev = wx.TextCtrl(self.mainPanel, wx.ID_ANY, "")
        self.tcSchemeRev.SetMinSize((40, 22))
        sizer_2.Add(self.tcSchemeRev, 0, wx.LEFT | wx.RIGHT, 5)
        
        self.panel_4 = wx.Panel(self.mainPanel, wx.ID_ANY)
        self.panel_4.SetMinSize((545, 28))
        sizer_6.Add(self.panel_4, 0, 0, 0)
        ...
        sizer_11.Add(self.btnDeleteScheme, 0, wx.LEFT | wx.RIGHT | wx.TOP, 5)
        
        self.panel_5 = wx.Panel(self.mainPanel, wx.ID_ANY)
        self.panel_5.SetMinSize((50, 26))
        ...
        sizer_11.Add(self.btnRemoveInstruction, 0, wx.LEFT | wx.RIGHT | wx.TOP, 5)
